  ...
  return (
    <Section id="#features" className="border-4 border-teal-500">
      <div className="bg-amber-500 container relative z-2">
        ...
        <div className="bg-sky-700 flex flex-wrap gap-10 justify-center mb-10">
          {benefits.map((item) => (
            <div
              key={item.id}
            ...
            >
              <div className="relative z-2 flex flex-col min-h-[22rem] p-[2.4rem] pointer-events-none">
                ...
                <div className="flex items-center mt-auto">
                  ...
                  <p className="ml-auto text-xs text-n-1 font-code font-bold uppercase tracking-wider">Explore more</p>
                  <Arrow />
                </div>
              </div>
