  ...
  return (
    <div className="flex max-lg:flex-wrap gap-[1rem]">
      {pricing.map((item) => (
        <div
          key={item.id}
          className="w-[19rem] max-lg:w-full lg:w-auto h-full border border-n-6 rounded-[2rem] px-6 even:py-14 odd:py-8 odd:my-4 [&>h4]:first:text-color-2 [&>h4]:even:text-color-1 [&>h4]:last:text-color-3 transition-colors duration-500 ease-in-out hover:border-color-1"
        >
