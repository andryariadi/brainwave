    ...
    <Section id="hero" className="pt-[12rem] -mt-[5.25rem]" crosses crossesOffset="lg:translate-y-[5.25rem]" customPaddings>
      <div className="container relative" ref={parallaxRef}>
        ...
        <div className="relative z-1 max-w-[62rem] mx-auto text-center mb-[4rem] md:mb-20 lg:mb-[6rem]">
          ...
          <p className="body-1 max-w-3xl mx-auto mb-6 lg:mb-8 text-n-1">Unleash the power of AI within Brainwave. Upgrade your productivity with Brainwave, the open AI chat app.</p>
        ...
        <div className="relative max-w-[23rem] md:max-w-5xl mx-auto xl:mb-24">
          ...
          {/* Background Image */}
          <div className="absolute -top-[54%] lg:-top-[104%] md:-top-[46%] left-1/2 -translate-x-1/2 w-[234%] md:w-[138%]">
